...
картинка доступ_без_sudo_2

Далее модно проверить версию установленного докер-копмоза:
```
docker-compose version
```
картинка проверка_наличия_композа_4
...
картинка гут_композ_8

Приложение собралось:

картинки билдинг_9, билдинг_10
...
картинки изоляция_11, билдинг_12, билдинг_13
